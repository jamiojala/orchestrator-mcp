...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to introduce outbox-driven cross-service communication with reliable publication and eventual consistency safeguards.
  ...
  - Validation plan covering `verify_eventual_consistency`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `verify_eventual_consistency` passes or explain why it cannot run
---
# Event-Driven Sync Engine

Superpower: Introduce outbox-driven cross-service communication with reliable publication and eventual consistency safeguards.
...
## Use this skill when
- The request signals `outbox pattern` or an equivalent domain problem.
- The request signals `event driven` or an equivalent domain problem.
- The request signals `eventual consistency` or an equivalent domain problem.
- The likely implementation surface includes `**/queue/**`.
- The likely implementation surface includes `**/events/**`.
...
## Handoff notes
- Treat ``verify_eventual_consistency`` as the minimum proof surface before calling the work complete.
