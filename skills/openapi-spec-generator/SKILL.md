...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to generate openapi documentation from typed routes and schemas without drifting from implementation.
  ...
  - Validation plan covering `verify_spec_completeness`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `verify_spec_completeness` passes or explain why it cannot run
---
# OpenAPI Spec Generator

Superpower: Generate OpenAPI documentation from typed routes and schemas without drifting from implementation.

## Use this skill when
- The request signals `openapi` or an equivalent domain problem.
- The request signals `zod schema` or an equivalent domain problem.
- The request signals `api docs` or an equivalent domain problem.
...
## Handoff notes
- Treat ``verify_spec_completeness`` as the minimum proof surface before calling the work complete.
