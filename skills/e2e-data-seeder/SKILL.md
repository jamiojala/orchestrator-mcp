...
prompt_template: |
  ...
  - Ensure `verify_data_consistency` passes or explain why it cannot run
---
# E2E Data Seeder
...
- The request signals `fixtures` or an equivalent domain problem.
...
## Handoff notes
- Treat ``verify_data_consistency`` as the minimum proof surface before calling the work complete.
