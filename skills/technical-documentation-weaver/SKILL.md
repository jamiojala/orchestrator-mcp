---
name: Technical Documentation Weaver
...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to transform technical knowledge into maintainable docs with runnable examples and structure that scales.
  ...
  - Validation plan covering `verify_doc_completeness`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `verify_doc_completeness` passes or explain why it cannot run
---
# Technical Documentation Weaver

Superpower: Transform technical knowledge into maintainable docs with runnable examples and structure that scales.
...
## Use this skill when
- The request signals `technical docs` or an equivalent domain problem.
- The request signals `mdx` or an equivalent domain problem.
- The request signals `versioned docs` or an equivalent domain problem.
...
## Handoff notes
- Treat ``verify_doc_completeness`` as the minimum proof surface before calling the work complete.
