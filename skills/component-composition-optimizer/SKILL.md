---
name: Component Composition Optimizer
...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to refactor prop-heavy react trees into compound components and cleaner composition apis with stronger inference.
  ...
  - Validation plan covering `verify_type_safety`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `verify_type_safety` passes or explain why it cannot run
---
# Component Composition Optimizer

Superpower: Refactor prop-heavy React trees into compound components and cleaner composition APIs with stronger inference.

## Use this skill when
- The request signals `prop drilling` or an equivalent domain problem.
- The request signals `compound component` or an equivalent domain problem.
- The request signals `react props` or an equivalent domain problem.
...
## Handoff notes
- Treat ``verify_type_safety`` as the minimum proof surface before calling the work complete.
