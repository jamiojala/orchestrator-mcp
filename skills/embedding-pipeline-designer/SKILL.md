---
name: Embedding Pipeline Designer
...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to build embedding pipelines with retrieval-aware chunking, vector index strategy, and similarity quality that can be measured.
  ...
  - Validation plan covering `embedding-quality-checker`, `vector-db-validator`, `search-accuracy-test`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `embedding-quality-checker` passes or explain why it cannot run
  - Ensure `vector-db-validator` passes or explain why it cannot run
  - Ensure `search-accuracy-test` passes or explain why it cannot run
---
# Embedding Pipeline Designer

Superpower: Build embedding pipelines with retrieval-aware chunking, vector index strategy, and similarity quality that can be measured.
...
## Use this skill when
- The request signals `embedding` or an equivalent domain problem.
- The request signals `vector db` or an equivalent domain problem.
- The request signals `semantic search` or an equivalent domain problem.
...
## Handoff notes
- Treat ``embedding-quality-checker`, `vector-db-validator`, `search-accuracy-test`` as the minimum proof surface before calling the work complete.
