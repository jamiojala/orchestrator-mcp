...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to protect graphql services from expensive queries with depth, complexity, and resource-aware limits.
  ...
  - Ensure `verify_query_limits` passes or explain why it cannot run
---
