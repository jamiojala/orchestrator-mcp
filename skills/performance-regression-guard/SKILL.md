...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to enforce performance budgets in ci so regressions are blocked before they become user-visible.
...
## Use this skill when
- The request signals `lighthouse ci` or an equivalent domain problem.
- The request signals `performance budget` or an equivalent domain problem.
- The request signals `regression` or an equivalent domain problem.
- The likely implementation surface includes `**/.github/workflows/**`.
- The likely implementation surface includes `**/lighthouse*.js`.
