...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to model runway, scenario changes, and hiring tradeoffs so founders can make clearer operational decisions.
  ...
  - Validation plan covering `verify_calculation_accuracy`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `verify_calculation_accuracy` passes or explain why it cannot run
---
...
- The request signals `runway` or an equivalent domain problem.
- The request signals `scenario model` or an equivalent domain problem.
- The likely implementation surface includes `**/*.csv`.
- The likely implementation surface includes `**/*.md`.
- The likely implementation surface includes `**/finance/**`.
...
## Handoff notes
- Treat ``verify_calculation_accuracy`` as the minimum proof surface before calling the work complete.
