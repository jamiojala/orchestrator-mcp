...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to compose kubernetes manifests with overlays, health checks, and safer secret boundaries across environments.
  ...
  - Ensure `verify_manifest_validity` passes or explain why it cannot run
---
