...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to put model versioning, experiment tracking, drift detection, and rollback policy around production ai systems.
  ...
  - Validation plan covering `ab-test-validator`, `drift-detection-checker`, `version-control-verifier`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `ab-test-validator` passes or explain why it cannot run
  - Ensure `drift-detection-checker` passes or explain why it cannot run
  - Ensure `version-control-verifier` passes or explain why it cannot run
---
...
## Use this skill when
- The request signals `model governance` or an equivalent domain problem.
- The request signals `drift detection` or an equivalent domain problem.
- The request signals `model versioning` or an equivalent domain problem.
...
## Handoff notes
- Treat ``ab-test-validator`, `drift-detection-checker`, `version-control-verifier`` as the minimum proof surface before calling the work complete.
