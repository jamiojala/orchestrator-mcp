...
task_types:
  ...
  - architecture
  - review
prompt_template: Build a concrete threat model for the provided workflow. Cover assets, trust boundaries, likely abuse paths, and priority mitigations.
---
...
## Use this skill when
- The request signals `threat model` or a directly related problem.
- The request signals `attack surface` or a directly related problem.
- The request signals `privacy model` or a directly related problem.
- The request signals `agent workflow security` or a directly related problem.
