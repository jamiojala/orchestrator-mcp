---
name: Cohort Retention Engineer
...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to build cohort retention logic and churn views that survive product evolution and messy subscription edge cases.
  ...
  - Validation plan covering `verify_retention_calculation`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `verify_retention_calculation` passes or explain why it cannot run
---
# Cohort Retention Engineer

Superpower: Build cohort retention logic and churn views that survive product evolution and messy subscription edge cases.
...
## Use this skill when
- The request signals `cohort` or an equivalent domain problem.
- The request signals `retention` or an equivalent domain problem.
- The request signals `churn` or an equivalent domain problem.
...
## Handoff notes
- Treat ``verify_retention_calculation`` as the minimum proof surface before calling the work complete.
