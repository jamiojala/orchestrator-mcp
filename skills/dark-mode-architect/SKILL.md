...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to implement theme systems with contrast safety, system preference support, and smooth state transitions.
  ...
  - Validation plan covering `verify_color_contrast`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `verify_color_contrast` passes or explain why it cannot run
---
# Dark Mode Architect

Superpower: Implement theme systems with contrast safety, system preference support, and smooth state transitions.
...
## Use this skill when
- The request signals `dark mode` or an equivalent domain problem.
- The request signals `theme toggle` or an equivalent domain problem.
- The request signals `color contrast` or an equivalent domain problem.
...
## Handoff notes
- Treat ``verify_color_contrast`` as the minimum proof surface before calling the work complete.
