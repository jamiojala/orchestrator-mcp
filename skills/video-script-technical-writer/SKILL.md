---
name: Video Script Technical Writer
...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to turn product and code explanations into structured tutorial scripts with stronger pacing and teaching clarity.
  ...
  - Validation plan covering `verify_engagement_retention`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `verify_engagement_retention` passes or explain why it cannot run
---
...
## Use this skill when
- The request signals `tutorial video` or an equivalent domain problem.
- The request signals `technical script` or an equivalent domain problem.
- The request signals `walkthrough` or an equivalent domain problem.
- The likely implementation surface includes `**/*.md`.
- The likely implementation surface includes `**/docs/**`.
- The likely implementation surface includes `**/scripts/**`.
...
## Handoff notes
- Treat ``verify_engagement_retention`` as the minimum proof surface before calling the work complete.
