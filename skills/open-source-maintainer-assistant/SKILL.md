...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to improve maintainer throughput with issue triage, contributor onboarding, and review-ready response scaffolds.
...
## Use this skill when
- The request signals `issue triage` or an equivalent domain problem.
- The request signals `maintainer` or an equivalent domain problem.
- The request signals `contributor onboarding` or an equivalent domain problem.
...
## Handoff notes
- Treat ``verify_response_time`` as the minimum proof surface before calling the work complete.
