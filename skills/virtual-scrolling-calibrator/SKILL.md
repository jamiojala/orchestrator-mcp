---
name: Virtual Scrolling Calibrator
...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to introduce high-volume list rendering with dynamic height support and smooth scrolling under real data load.
  ...
  - Validation plan covering `audit_render_performance`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `audit_render_performance` passes or explain why it cannot run
---
# Virtual Scrolling Calibrator

Superpower: Introduce high-volume list rendering with dynamic height support and smooth scrolling under real data load.
...
## Use this skill when
- The request signals `virtual list` or an equivalent domain problem.
- The request signals `windowing` or an equivalent domain problem.
- The request signals `large list` or an equivalent domain problem.
- The likely implementation surface includes `**/*.tsx`.
- The likely implementation surface includes `**/*list*.tsx`.
...
## Handoff notes
- Treat ``audit_render_performance`` as the minimum proof surface before calling the work complete.
