...
prompt_template: |
  ...
  ## Your Task
  Use the supplied code, architecture, or product context to build practical b2b health scoring from usage, support, and churn signals without magical black-box metrics.
  ...
  - Validation plan covering `verify_prediction_accuracy`.
  - Include the most likely failure modes, operator notes, and composition boundaries with adjacent systems or skills.
  
  ## Validation Checklist
  - Ensure `verify_prediction_accuracy` passes or explain why it cannot run
---
# Customer Health Scorer

Superpower: Build practical B2B health scoring from usage, support, and churn signals without magical black-box metrics.
...
## Use this skill when
- The request signals `customer health` or an equivalent domain problem.
- The request signals `churn risk` or an equivalent domain problem.
- The request signals `b2b saas` or an equivalent domain problem.
- The likely implementation surface includes `**/*.sql`.
- The likely implementation surface includes `**/*.csv`.
- The likely implementation surface includes `**/crm/**`.
...
## Handoff notes
- Treat ``verify_prediction_accuracy`` as the minimum proof surface before calling the work complete.
